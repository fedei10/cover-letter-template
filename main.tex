...
% Personalization: Address to a specific person if possible
% Example: \recipient{Ms. Jane Doe}{Company Name}
\recipient{[Hiring Manager's Name]}{[Company Name]}
% Date (automatically set to today)
\date{\today}
% Opening salutation (personalize if possible)
\opening{Dear [Hiring Manager's Name],}
% Closing phrase
\closing{Sincerely,}
% Enclosure (e.g., CV attached)
...
% Generate the letter closing (footer)
\makeletterclosing
